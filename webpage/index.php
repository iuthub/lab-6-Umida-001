...
<dl>
    <dt>Name</dt>
    <dd>
        <input type="text" name="name" minlegth="2" required>
    </dd>
    ...
    <dt>Username</dt>
    <dd>
        <input type="text" name="username" minlegth="5" required>
    </dd>

    <dt>Password</dt>
    <dd>
        <input type="password" name="password" minlegth="8" required>
    </dd>
    ...
    <dt>Postal Code</dt>
    <dd>
        <input type="text" name="postalCode" maxlength="6" required>
    </dd>
